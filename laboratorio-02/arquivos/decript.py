...
def decrypt_file(input_filename, output_filename, key):
    try:
            ...
            with open(output_filename, "wb") as decrypted_file:
                while True:
                    chunk = encrypted_file.read(
                        1024
                    )  # Lê o arquivo criptografado em blocos de 1 KB
                    if not chunk:
                        break
        ...
        print(
            f"Arquivo '{input_filename}' descriptografado com sucesso em '{output_filename}'"
        )
...
if __name__ == "__main__":
    ...
    decrypt_file(
        encrypted_file_name, decrypted_file_name, decryption_key
